...
<div class="reveal-modal" id="metro" style="heigth: 100%;">
    ...
    <div style="float: left; margin-left: 35px; margin-top: 25px;">
        ...
        <div id="select-metro" style="padding-left: 10px; padding-right: 10px;  font-size: 14px;">
            
        </div>
        <button onclick="$('#metro').hide();return false;" style="background: #4579A6;border: none; border-radius: 4px; color: white;  height: 44px;  font: 18px/30px 'PT Sans';  padding: 0px 20px 0px 20px;  margin-top: 8px;">
            Выбрать
        </button>
        <button onclick="
