...
<ul id="how-it-works">
	<li id="one">1. Сбор объявлений <br/>Мы находим новые объявления о сдаваемой недвижимости, с помощью социальных сетей, досок объявлений и базличных баз жилья. Так же, не мало объектов добавляют и сами пользователи.</li>
	<li id="two">2. Автоматическая проверка <br/>Все новые объявления сверяются со списком агентов и нечестных арендодателей, и таким образом автоматически очищаются.</li>
