...
class Smsc extends CApplicationComponent
{
	...
	public $SMSC_LOGIN = 'aspartam007';							 // логин клиента
	public $SMSC_PASSWORD='09676bed68d9496fb27ce470477bb2f8'; 	// пароль или MD5-хеш пароля в нижнем регистре
	public $SMSC_POST=0; 										// использовать метод POST
	public $SMSC_HTTPS=0;				 						// использовать HTTPS протокол
	public $SMSC_CHARSET='utf-8'; 								// кодировка сообщения: utf-8, koi8-r или windows-1251 (по умолчанию)
